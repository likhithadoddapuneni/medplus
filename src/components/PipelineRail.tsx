    ...
    <div className="flex items-center gap-3">
      ...
      <div className="min-w-0">
        ...
        <div
          ...
          style={{ color: state === "active" ? ui.hex : "#A9C0B9" }}
        >
...
function StageIcon({
  ...
  return (
    <div
      ...
      style={{
        borderColor: lit ? ui.hex : "#CCDFDA",
        color: lit ? ui.hex : "#9BB5AE",
        background: "#F8FCFB",
      }}
    >
      {state === "active" ? (
          ...
          <div key={id} className="flex items-center gap-1">
            ...
            {i < order.length - 1 && (
              <span
                ...
                style={{
                  background:
                    states[id] === "done" ? AGENT_UI[id].hex : "#CCDFDA",
                }}
              />
            )}
          </div>
    ...
    <div className="flex flex-col">
      ...
      <svg viewBox="0 0 200 44" className="h-11 w-full" preserveAspectRatio="none" aria-hidden="true">
        ...
        <path
          ...
          fill="none"
          stroke={triageLit ? AGENT_UI.triage.hex : "#CCDFDA"}
          strokeWidth="1.5"
        />
        ...
        <path
          ...
          fill="none"
          stroke={mgmtLit ? AGENT_UI.management.hex : "#CCDFDA"}
          strokeWidth="1.5"
        />
      </svg>
            ...
            <div key={id} className="relative flex items-center py-1">
              {i < sequential.length - 1 && (
                <span
                  ...
                  style={{ background: states[id] === "done" ? ui.hex : "#CCDFDA" }}
                />
              )}
