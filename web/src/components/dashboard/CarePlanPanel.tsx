...
> = {
  STAT: { icon: Lightning, label: "STAT — order now", hex: "#D8443C" },
  URGENT: { icon: Clock, label: "Urgent — within 60 min", hex: "#D2682F" },
  IMAGING: { icon: Camera, label: "Imaging", hex: "#0E8C7F" },
  ECG: { icon: Pulse, label: "ECG priorities", hex: "#2E6FA3" },
};
